    ...
    <div className="min-h-screen bg-[#f8f5f0]">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-serif font-light text-[#2c2c2c] mb-4">Shop Our Collection</h1>
          <p className="text-[#5c5c5c] max-w-2xl mx-auto">
            Discover our handcrafted crystal bracelets, each designed with intention to support your journey.
          </p>
        </div>
